...
const Head = () => {
  ...
  return (
    <div className="grid grid-flow-col p-3 xs:p-4 sm:p-5 m-2 shadow-lg">
  <div className="flex col-span-1">
        <img
          onClick={() => toggleMenuHandler()}
          className="h-6 xs:h-7 sm:h-8 cursor-pointer"
          alt="menu"
      ...
      <div className="col-span-10 px-10">
        <div>
          ...
          />
          <button className="p-2 border border-gray-400 rounded-r-full px-5 py-2 bg-gray-100">
            🔍
          </button>
        </div>
        {showSuggestions && (
